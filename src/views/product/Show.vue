...
export default {
  ...
  methods: {
    getProduct(id) {
      this.axios.get(`http://localhost:8000/api/products/${this.$route.params.id}`)
          .then(res => {
                  ...
                  <ul class="shop-details-top-safe-checkout-list">
                    <li>
                      <div class="shop-details-top-safe-checkout-img"> <a href="#0"><img
                          src="/src/assets/images/shop/shop-details-top-safe-checkout-img-1.jpg"
                          alt=""></a> </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"> <a href="#0"><img
                          src="/src/assets/images/shop/shop-details-top-safe-checkout-img-2.jpg"
                          alt=""></a> </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"> <a href="#0"><img
                          src="/src/assets/images/shop/shop-details-top-safe-checkout-img-3.jpg"
                          alt=""></a> </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"> <a href="#0"><img
                          src="/src/assets/images/shop/shop-details-top-safe-checkout-img-4.jpg"
                          alt=""></a> </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"> <a href="#0"><img
                          src="/src/assets/images/shop/shop-details-top-safe-checkout-img-5.jpg"
                          alt=""></a> </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img"> <a href="#0"><img
                          src="/src/assets/images/shop/shop-details-top-safe-checkout-img-7.jpg"
                          alt=""></a> </div>
                    </li>
                  </ul>
                </div>
